    ...
    <Card>
      <CardHeader>
        <CardTitle className="flex items-center gap-2">
          ...
          {t("portal.makePayment")}
        </CardTitle>
        <CardDescription>
          {t("portal.chooseMethod")}
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-6">
        {/* Payment Amount Input */}
        <div className="space-y-2">
          <Label htmlFor="payment-amount">{t("portal.paymentAmount")}</Label>
          <div className="flex gap-2">
            ...
            >
              {t("portal.monthly")} ({formatCurrency(paymentAmount)})
            </Button>
          </div>
          <p className="text-xs text-muted-foreground">
            {t("portal.currentBalanceLabel")}: {formatCurrency(currentBalance)}
          </p>
        </div>
        ...
        {cashAppTag?.is_enabled && cashAppTag.setting_value && (
          <div className="space-y-3">
            <div className="flex items-center gap-2">
              ...
              <span className="font-medium">{t("portal.cashApp")}</span>
            </div>
            <p className="text-sm text-muted-foreground">
        ...
        {zelleContact?.is_enabled && zelleContact.setting_value && (
          <div className="space-y-3">
            <div className="flex items-center gap-2">
              ...
              <span className="font-medium">{t("portal.zelle")}</span>
            </div>
            <p className="text-sm text-muted-foreground">
            ...
            <p className="text-xs text-muted-foreground">
              {t("portal.sendToZelle").replace("{contact}", zelleContact.setting_value)}
            </p>
          </div>
        )}
