  ...
  public: {
    Tables: {
      ...
      vehicle_cost_breakdowns: {
        ...
        Relationships: [
          {
            foreignKeyName: "vehicle_cost_breakdowns_vehicle_id_fkey"
            columns: ["vehicle_id"]
            isOneToOne: false
            referencedRelation: "vehicles"
            referencedColumns: ["id"]
      ...
      vehicle_cost_documents: {
        ...
        Relationships: [
          {
            foreignKeyName: "vehicle_cost_documents_vehicle_id_fkey"
            columns: ["vehicle_id"]
            isOneToOne: false
            referencedRelation: "vehicles"
            referencedColumns: ["id"]
